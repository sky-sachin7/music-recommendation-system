...
music_dict = pickle.load(open(r'C:\IITPATNA\semester2\Development\PythonProject\venv_music\Music_recommendation_system\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'C:\IITPATNA\semester2\Development\PythonProject\venv_music\Music_recommendation_system\similarities.pkl', 'rb'))
